...
(async () => {
    try {
      ...
      if (rows[0].count === 0) {
        ...
        VALUES (1, 1, 2, 4, 'very good'), (2, 1, 2, 1, 'very bad'), SELECT dog_id FROM Dogs WHERE name = 'Martin'), '2025-06-12 09:30:00', 30, 'Sad Ave', 'accepted'), ((SELECT dog_id FROM Dogs WHERE name = 'Kai'), '2025-06-16 09:30:00', 30, 'Avenue Ave', 'open');
        `);
      }
    } catch (err) {
